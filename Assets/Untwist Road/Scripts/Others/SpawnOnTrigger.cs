...
public class SpawnOnTrigger : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider target)
    {
        ...
        {
            if (!check) //When touching the player, pass him the coordinates of the start of the spawn, the distance, turn on the spawn, turn off the Ground, if this is a spawn at the finish, then Finish = true;
            {
